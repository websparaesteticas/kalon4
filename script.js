...
const servicesData={
  faciales:{
    ...
    wa:'Hola! Quiero reservar un turno de Faciales en KÂLON Multiespacio Estético'
  },
  manicuria:{
    num:'02',
    ...
    wa:'Hola! Quiero reservar un turno de Manicuría y Belleza de Pies en KÂLON Multiespacio Estético'
  },
  depilacion:{
    num:'03',
    title:'Depilación',
    ...
    wa:'Hola! Quiero reservar un turno de Depilación en KÂLON Multiespacio Estético'
  },
  masajes:{
    num:'04',
    title:'Masajes',
    ...
    wa:'Hola! Quiero reservar un turno de Masajes en KÂLON Multiespacio Estético'
  },
  podologia:{
    num:'05',
    ...
    wa:'Hola! Quiero reservar un turno de Podología Clínica en KÂLON Multiespacio Estético'
  },
  reiki:{
    num:'06',
    ...
    wa:'Hola! Quiero reservar un turno de Reiki y Liberación en KÂLON Multiespacio Estético'
  },
  pestanas:{
    num:'07',
    title:'Pestañas',
    ...
    wa:'Hola! Quiero reservar un turno de Pestañas en KÂLON Multiespacio Estético'
  },
  corporales:{
    num:'08',
    ...
    items:['Hifu corporal'],
    wa:'Hola! Quiero reservar un turno de Tratamientos Corporales en KÂLON Multiespacio Estético'
  }
};
